...
export const metadata: Metadata = {
  title: 'Graha Taman Pelangi - BSB City',
  description: 'Graha Taman Pelangi adalah salah satu kawasan hunian di dalam pengembangan kota baru BSB City.',
};

const GrahaPelangiPage = () => {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[1.7fr_1.1fr] items-start">
          <div>
            <div className="relative rounded-3xl overflow-hidden border border-emerald-500/20 bg-gradient-to-br from-emerald-500/20 via-slate-900 to-slate-950 mb-8">
              ...
              <div className="relative aspect-[16/9]">
                <Image
                  src="/images/clusters/graha-pelangi.jpg"
                  alt="Graha Taman Pelangi - BSB City"
                  fill
              ...
              <div className="relative p-6 md:p-8 flex flex-col gap-6">
                <div>
                  ...
                  <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-50 mb-3">Graha Taman Pelangi</h1>
                  <p className="text-sm md:text-base text-slate-200 max-w-xl">
                    Graha Taman Pelangi merupakan salah satu cluster hunian yang dikembangkan di BSB City. Informasi resmi mengenai
                    produk dan fasilitas dapat diperoleh melalui pengembang dan marketing gallery.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <section>
                <h2 className="text-lg font-semibold tracking-tight text-slate-50 mb-3">Sekilas Graha Taman Pelangi</h2>
                <p className="text-sm leading-relaxed text-slate-200/90 mb-4">
                  Graha Taman Pelangi merupakan salah satu cluster hunian yang berada di kawasan BSB City. Rincian lebih lanjut
                  mengenai produk, tipe unit, dan fasilitas resmi dapat diperoleh melalui marketing gallery atau kanal resmi BSB City.
                </p>
              </section>
            </div>
          </div>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28">
            <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-slate-900 to-slate-950 p-6 shadow-[0_0_40px_rgba(16,185,129,0.35)]">
              <h3 className="text-base font-semibold text-slate-50 mb-2">Cari hunian untuk keluarga?</h3>
              <p className="text-sm text-slate-200 mb-4">
                Konsultasikan kebutuhan hunian keluarga Anda dengan tim kami dan temukan unit terbaik di Graha Taman Pelangi.
              </p>
              ...
              <div className="mt-5 grid gap-3">
                <Link
                  href="/booking?cluster=graha-pelangi"
                ...
                <Link
                  href="/contact?cluster=graha-pelangi"
...
export default GrahaPelangiPage;
