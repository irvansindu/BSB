...
export const metadata: Metadata = {
  title: 'Graha Taman Bunga - BSB City',
  description: 'Graha Taman Bunga adalah salah satu kawasan hunian di dalam pengembangan kota baru BSB City.',
};

const GrahaBungaPage = () => {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[1.7fr_1.1fr] items-start">
          <div>
            <div className="relative rounded-3xl overflow-hidden border border-emerald-500/20 bg-gradient-to-br from-emerald-500/20 via-slate-900 to-slate-950 mb-8">
              ...
              <div className="relative aspect-[16/9]">
                <Image
                  src="/images/clusters/graha-bunga.jpg"
                  alt="Graha Taman Bunga - BSB City"
                  fill
              ...
              <div className="relative p-6 md:p-8 flex flex-col gap-6">
                <div>
                  ...
                  <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-50 mb-3">Graha Taman Bunga</h1>
                  <p className="text-sm md:text-base text-slate-200 max-w-xl">
                    Graha Taman Bunga merupakan salah satu cluster hunian yang dikembangkan di kawasan BSB City. Detail mengenai produk
                    dan fasilitas resmi dapat dikonfirmasi melalui pengembang dan marketing gallery.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <section>
                <h2 className="text-lg font-semibold tracking-tight text-slate-50 mb-3">Sekilas Graha Taman Bunga</h2>
                <p className="text-sm leading-relaxed text-slate-200/90 mb-4">
                  Graha Taman Bunga merupakan salah satu cluster hunian di BSB City. Penjelasan resmi mengenai spesifikasi produk dan
                  fasilitas dapat diperoleh melalui pengembang serta marketing gallery BSB City.
                </p>
              </section>
            </div>
          </div>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28">
            <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-slate-900 to-slate-950 p-6 shadow-[0_0_40px_rgba(16,185,129,0.35)]">
              <h3 className="text-base font-semibold text-slate-50 mb-2">Ingin tinggal di lingkungan taman?</h3>
              <p className="text-sm text-slate-200 mb-4">
                Hubungi tim penjualan kami untuk informasi unit tersedia dan jadwal kunjungan ke Graha Taman Bunga.
              </p>
              ...
              <div className="mt-5 grid gap-3">
                <Link
                  href="/booking?cluster=graha-bunga"
                ...
                <Link
                  href="/contact?cluster=graha-bunga"
