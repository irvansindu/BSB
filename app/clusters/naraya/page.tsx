...
export const metadata: Metadata = {
  title: 'Naraya Residence - BSB City',
  description: 'Naraya Residence adalah salah satu kawasan hunian di dalam pengembangan kota baru BSB City.',
};
        ...
        <div className="grid gap-10 lg:grid-cols-[1.7fr_1.1fr] items-start">
          <div>
            <div className="relative rounded-3xl overflow-hidden border border-emerald-500/20 bg-gradient-to-br from-emerald-500/20 via-slate-900 to-slate-950 mb-8">
              ...
              <div className="relative aspect-[16/9]">
                <Image
                  src="/images/clusters/naraya.jpg"
                  alt="Naraya Residence - BSB City"
                  fill
              ...
              <div className="relative p-6 md:p-8 flex flex-col gap-6">
                <div>
                  ...
                  <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-50 mb-3">Naraya Residence</h1>
                  <p className="text-sm md:text-base text-slate-200 max-w-xl">
                    Naraya Residence merupakan salah satu kawasan hunian yang dikembangkan di BSB City, kota baru di perbukitan dengan
                    lingkungan hijau dan suasana yang lebih sejuk.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <section>
                <h2 className="text-lg font-semibold tracking-tight text-slate-50 mb-3">Sekilas Naraya Residence</h2>
                <p className="text-sm leading-relaxed text-slate-200/90 mb-4">
                  Naraya Residence merupakan salah satu cluster hunian yang direncanakan sebagai bagian dari lingkungan BSB City.
                  Informasi lebih detail mengenai tipe unit, spesifikasi, dan fasilitas resmi dapat diperoleh melalui marketing gallery
                  atau kanal komunikasi resmi BSB City.
                </p>
              </section>
            </div>
          </div>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28">
            <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-slate-900 to-slate-950 p-6 shadow-[0_0_40px_rgba(16,185,129,0.35)]">
              <h3 className="text-base font-semibold text-slate-50 mb-2">Ingin tinggal di Naraya?</h3>
              <p className="text-sm text-slate-200 mb-4">
                Tim kami siap membantu Anda memilih unit terbaik dan menjelaskan skema pembayaran yang paling sesuai dengan rencana keuangan Anda.
              </p>
