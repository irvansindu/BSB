...
export const metadata: Metadata = {
  title: 'BSB Village - BSB City',
  description: 'BSB Village adalah salah satu kawasan hunian di dalam pengembangan kota baru BSB City.',
};

const BsbVillagePage = () => {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[1.7fr_1.1fr] items-start">
          <div>
            <div className="relative rounded-3xl overflow-hidden border border-emerald-500/20 bg-gradient-to-br from-emerald-500/20 via-slate-900 to-slate-950 mb-8">
              ...
              <div className="relative aspect-[16/9]">
                <Image
                  src="/images/clusters/bsb-village.jpg"
                  alt="BSB Village - BSB City"
                  fill
              ...
              <div className="relative p-6 md:p-8 flex flex-col gap-6">
                <div>
                  ...
                  <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-slate-50 mb-3">BSB Village</h1>
                  <p className="text-sm md:text-base text-slate-200 max-w-xl">
                    BSB Village merupakan salah satu cluster hunian yang berada di kawasan kota baru BSB City. Rincian resmi mengenai
                    produk dan fasilitas dapat dikonfirmasi melalui pengembang atau marketing gallery BSB City.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <section>
                <h2 className="text-lg font-semibold tracking-tight text-slate-50 mb-3">Sekilas BSB Village</h2>
                <p className="text-sm leading-relaxed text-slate-200/90 mb-4">
                  BSB Village merupakan salah satu cluster hunian di BSB City. Informasi resmi mengenai detail produk dan fasilitas
                  dapat dikonfirmasi langsung melalui pengembang atau marketing gallery.
                </p>
              </section>
            </div>
          </div>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28">
            <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-b from-slate-900 to-slate-950 p-6 shadow-[0_0_40px_rgba(16,185,129,0.35)]">
              <h3 className="text-base font-semibold text-slate-50 mb-2">Tertarik dengan BSB Village?</h3>
              <p className="text-sm text-slate-200 mb-4">
                Diskusikan pilihan unit dan skema pembayaran dengan tim sales kami untuk menemukan hunian terbaik di BSB Village.
              </p>
              ...
              <div className="mt-5 grid gap-3">
                <Link
                  href="/booking?cluster=bsb-village"
                ...
                <Link
                  href="/contact?cluster=bsb-village"
